...
const Calculator = () => {
  ...
  const handleCheckboxChange = (e) => {
    ...
    setFormData((prevFormData) => ({
      ...prevFormData,
      question1: checked
        ? [...(Array.isArray(prevFormData.question1) ? prevFormData.question1 : []), value]
        : prevFormData.question1.filter((v) => v !== value)
    }));
  };
            ...
            <div className="container container-ex">
                <div className="row">
                    <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <br/><br/>
                        <Button className='calculator__btn-2' variant="success" onClick={() => handleModalShow('question1')}>
                                ...
                                <div className="t-input-block">
                                    <ul className="t-checkboxeswrapper">
                                        <li className="t-checkboxesitem">
                                            ...
                                            <input type="checkbox" value="Офис" className="t-checkbox" onChange={handleCheckboxChange} />
                                            <div className="t-checkboxindicator" style={{ borderColor: '#76b82a' }}></div>Офис
                                            </label>
                                        </li>
                                        <li className="t-checkboxesitem">
                                            <label className="t-checkboxcontrols t-text t-textxs" style={{ color: '#252c35' }}>
                                            <input type="checkbox" value="Магазин/торговое помещение" className="t-checkbox" onChange={handleCheckboxChange} />
                                            <div className="t-checkboxindicator" style={{ borderColor: '#76b82a' }}></div>Магазин/торговое помещение
                                            </label>
                                        </li>
                                        <li className="t-checkboxesitem">
                                            <label className="t-checkboxcontrols t-text t-textxs" style={{ color: '#252c35' }}>
                                            <input type="checkbox" value="Бассейн" className="t-checkbox" onChange={handleCheckboxChange} />
                                            <div className="t-checkboxindicator" style={{ borderColor: '#76b82a' }}></div>Бассейн
                                            </label>
                                        </li>
                                        <li className="t-checkboxesitem">
                                            <label className="t-checkboxcontrols t-text t-textxs" style={{ color: '#252c35' }}>
                                            <input type="checkbox" value="Частный дом/коттедж" className="t-checkbox" onChange={handleCheckboxChange} />
                                        ...
                                        <li className="t-checkboxes__item">
                                            ...
                                            <input type="checkbox" value="Квартира" className="t-checkbox" onChange={handleCheckboxChange} />
                                            <div className="t-checkbox__indicator" style={{ borderColor: '#76b82a' }}></div>Квартира
                                            </label>
                                        </li>
                                        <li className="t-checkboxes__item">
                                            <label className="t-checkbox__controls t-text t-text_xs" style={{ color: '#252c35' }}>
                                            <input type="checkbox" value="Кафе/ресторан/бар" className="t-checkbox" onChange={handleCheckboxChange} />
                                            <div className="t-checkbox__indicator" style={{ borderColor: '#76b82a' }}></div>Кафе/ресторан/бар
                                            </label>
                                        </li>
                                        <li className="t-checkboxes__item">
                                            <label className="t-checkbox__controls t-text t-text_xs" style={{ color: '#252c35' }}>
                                            <input type="checkbox" value="Промышленное помещение/цех" className="t-checkbox" onChange={handleCheckboxChange} />
                                            <div className="t-checkbox__indicator" style={{ borderColor: '#76b82a' }}></div>Промышленное помещение/цех
                                            </label>
                                        </li>
                                        <li className="t-checkboxes__item">
                                            <label className="t-checkbox__controls t-text t-text_xs" style={{ color: '#252c35' }}>
                                            <input type="checkbox" value="Гостиница" className="t-checkbox" onChange={handleCheckboxChange} />
                                            <div className="t-checkbox__indicator" style={{ borderColor: '#76b82a' }}></div>Гостиница
                                            </label>
                                        </li>
                                        <li className="t-checkboxes__item">
                                            <label className="t-checkbox__controls t-text t-text_xs" style={{ color: '#252c35' }}>
                                            <input type="checkbox" value="Медицинское учреждение" className="t-checkbox" onChange={handleCheckboxChange} />
                                            <div className="t-checkbox__indicator" style={{ borderColor: '#76b82a' }}></div>Медицинское учреждение
                                            </label>
                                        </li>
                                        <li className="t-checkboxes__item">
                                            <label className="t-checkbox__controls t-text t-text_xs" style={{ color: '#252c35' }}>
                                            <input type="checkbox" value="Другое" className="t-checkbox" onChange={handleCheckboxChange} />
                            ...
                            <div className="popup_dialog">
                                ...
                                <div className="t862__quiz-form-wrapper">
                                    ...
                                    <div className="t-input-group t-input-group_rd t-input-group-step_active" role="group" style={{ display: 'block' }}>
                                        <div className="t-input-title t-descr t-descr_md" style={{ color: '#252c35', fontWeight: 700 }}>Ваш ответ на вопрос {index + 2}</div>
                                        <div className="t-input-block">
                                        <Form.Control
                                            type="text"
                                            name={question}
