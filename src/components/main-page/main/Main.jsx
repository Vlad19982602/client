...
                                <Form.Control className='main__input' type="text" placeholder="Введите ваше имя" required />
                                <Form.Control className='main__input' type="text" placeholder="Введите ваш телефон" required />
                                <div className='main__form'>
                                    <Button className='main__btn' variant="success" type="submit">
                                        <div>Набрать менеджеру</div>
                                    </Button>
                                </div>
